...
public class DeluxeBFS {
    ...
    /**
     * Computes the shortest path from <tt>s</tt> 
    ...
    /**
     * Computes the shortest path from any one 
     * of the source vertices in <tt>sources</tt>
    ...
    //qiang
    public boolean[] fathers() {
        boolean[] dest = new boolean[marked.length];
        System.arraycopy(marked, 0, dest, 0, marked.length);
        return dest;
    }
